...
new const zclass3_info[] = { "Vida- Salto+" }
...
new const zclass4_name[] = { "Zombie Tanque" }
new const zclass4_info[] = { "Vida++ Velocidad-" }
...
new const zclass5_name[] = { "Zombie Admin" }
new const zclass5_info[] = { "Vida++ Velocidad+" }
new const zclass5_model[] = { "bb_admin" }
new const zclass5_clawmodel[] = { "v_bloodyhands" }
const zclass5_health = 3800
const zclass5_speed = 300
const Float:zclass5_gravity = 0.9
const zclass5_adminflags = ADMIN_ADMIN
#define ADMIN_ARMOR 200
...
{
	register_plugin("[BB] BlackTouch Zombies", "1.0", "BlackTouch")
	
	// Register all classes
	g_zclass_classic = bb_register_zombie_class(zclass1_name, zclass1_info, zclass1_model, zclass1_clawmodel, zclass1_health, zclass1_speed, zclass1_gravity, 0.0, zclass1_adminflags)
	...
	g_zclass_admin = bb_register_zombie_class(zclass5_name, zclass5_info, zclass5_model, zclass5_clawmodel, zclass5_health, zclass5_speed, zclass5_gravity, 0.0, zclass5_adminflags)
}
...
public ham_PlayerSpawn_Post(id)
{
	...
	{
		if (bb_get_user_zombie_class(id) == g_zclass_classic)
		{
			give_item(id, "item_assaultsuit");
			cs_set_user_armor(id, CLASSIC_ARMOR, CS_ARMOR_VESTHELM);
		}
		else if (bb_get_user_zombie_class(id) == g_zclass_tanker)
		{
			give_item(id, "item_assaultsuit");
			cs_set_user_armor(id, TANK_ARMOR, CS_ARMOR_VESTHELM);
		}
		else if (bb_get_user_zombie_class(id) == g_zclass_admin)
		{
			give_item(id, "item_assaultsuit");
			cs_set_user_armor(id, ADMIN_ARMOR, CS_ARMOR_VESTHELM);
		}
	}
}
